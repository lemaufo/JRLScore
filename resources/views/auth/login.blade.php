<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div>
            ...
            <x-text-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" placeholder="Ingresa tu email"/>
        ...
        <div class="flex items-center justify-between mt-4">
            ...
            <!-- Privacy Policy -->
            <a href="{{ route('register') }}" class="text-sm text-gray-600 dark:text-gray-400 hover:underline">
        ...
        <div class="mt-24 mb-12 text-center">
            <h6 class="text-sm font-extralight text-gray-600 dark:text-gray-500">{{ __('© JRLScore 2025') }}</h6>
        </div>
    </form>
</x-guest-layout>
